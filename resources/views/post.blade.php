	...
	<section class="recomended-area section">
		<div class="container">
			<div class="row">
				...
				@foreach($randomposts as $randopost)

				<div class="col-lg-4 col-md-6">
					<div class="card h-100">
						<div class="single-post post-style-1">

							<div class="blog-image"><img src="{{ asset('storage/post/'.$randopost->image) }}" alt="Blog Image"></div>

							<a class="avatar" href="#"><img src="{{ asset('storage/profile/'.$randopost->user->image) }}" alt="Profile Image"></a>
								...
								<ul class="post-footer">
									 <li>
                                        @guest
                                            ...
                                            @else
                                            <a href="javascript:void(0);" onclick="document.getElementById('favorite-form-{{ $randopost->id }}').submit();"  
                                            class = "{{ !Auth::user()->favorite_posts->where('pivot.post_id',$post->id)->count() == 0 ? 
                                                'favorite_posts' : '' }}">
                                                <i class="ion-heart"></i>
                                                {{$randopost->favorite_to_users->count() }}
