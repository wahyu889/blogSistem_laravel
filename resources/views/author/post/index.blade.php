...
@section('content')
	 <div class="container-fluid">
         <div class="block-header">
                <h2>
                  <a href="{{ route('author.post.create')}}" class="btn btn-primary wafes-efffect">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($posts as $post)
                                            <tr>
                                                ...
                                                <td>
												  <a href = "{{ route('author.post.show', $post->id)}} " class="btn btn-primary wafes-effect">
                            <i class="material-icons">visibility</i>
                          </a>
                                       
                        	<a href = "{{ route('author.post.edit', $post->id)}} " class="btn btn-primary wafes-effect">
