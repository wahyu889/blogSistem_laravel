	 ...
	 <div class="container-fluid">
            ...
            @if($post->is_approved == false)
                ...
                onclick="approvePost({{ $post->id }})">
                 ...
                 <form id="approval-form-{{ $post->id }}" method="POST" action="{{route('admin.post.approve', $post->id)}}"  style="display: none;">
                    @csrf
                    @method('PUT')
                </form>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                {{ $post->title }}
                                <small><strong><a href="">{{ $post->user->name }}</a></strong> on {{ $post->created_at->toFormattedDateString() }}</small>
                            </h2>
                    ...
                    <div class="card ">
                        ...
                        <div class="body">
                            @foreach($post->categories as $category)
                                <span class="label bg-light-blue"> {{ $category->name }} </span>
