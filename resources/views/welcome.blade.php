...
@push('css')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/css/home/styles.css')}}">

<link rel="stylesheet" type="text/css" href="{{ asset('assets/frontend/css/home/responsive.css')}}">
<style type="text/css">
    .favorite_posts{
        color: blue;
    }
                ...
                @foreach($posts as $post)
                    ...
                    <div class="card h-100">
                        <div class="single-post post-style-1">
                            ...
                            <a class="avatar" href="#"><img src="{{ asset('storage/profile/'.$post->user->image) }}" alt="{{ $post->title }}"></a>
