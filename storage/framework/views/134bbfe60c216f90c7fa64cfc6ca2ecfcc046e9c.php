                        ...
                        <div class="body">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home_with_icon_title">
                                    <form class="form-horizontal" method="POST" action="<?php echo e(route('author.profil.update')); ?>" enctype="multipart/form-data">
                                   	<?php echo csrf_field(); ?>
                                ...
                                <div class="row clearfix">
                                  ...
                                  <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea name="about" rows="5" class="form-control"><?php echo e(Auth::user()->about); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="change_password_with_icon_title">
                                	...
                                	<form class="form-horizontal" method="POST" action="<?php echo e(route('author.password.update')); ?>">
                                   	<?php echo csrf_field(); ?>
                                   	<?php echo method_field('PUT'); ?>
...
<?php /* C:\xampp\htdocs\blog_sistem\resources\views/author/settings.blade.php */ ?>