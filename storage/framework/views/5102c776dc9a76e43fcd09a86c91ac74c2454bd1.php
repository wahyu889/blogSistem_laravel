                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         ...
                                         <button class="btn btn-danger wafes-effect" type="button" onclick="deleteComment(<?php echo e($comment->id); ?>)">
                                                    ...
                                                    <form id="delete-form-<?php echo e($comment->id); ?>" action="<?php echo e(route('author.comment.destroy', $comment->id)); ?>" method="POST" style="display: none;">
                                                      <?php echo csrf_field(); ?> 
...
<?php /* C:\xampp\htdocs\blog_sistem\resources\views/author/comments.blade.php */ ?>