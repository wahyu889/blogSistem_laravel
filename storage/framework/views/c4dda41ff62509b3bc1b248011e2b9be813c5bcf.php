...
<?php $__env->startSection('content'); ?>
	 <div class="container-fluid">
         <div class="block-header">
                <h2>
                  <a href="<?php echo e(route('author.post.create')); ?>" class="btn btn-primary wafes-efffect">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
												  <a href = "<?php echo e(route('author.post.show', $post->id)); ?> " class="btn btn-primary wafes-effect">
                            <i class="material-icons">visibility</i>
                          </a>
                                       
                        	<a href = "<?php echo e(route('author.post.edit', $post->id)); ?> " class="btn btn-primary wafes-effect">
														<i class="material-icons">edit</i>
													</a>
                                                    <button class="btn btn-danger wafes-effect" type="button" onclick="deletePost(<?php echo e($post->id); ?>)">
                                                        <i class="material-icons">delete</i>
                                                    </button>
                                                    <form id="delete-form-<?php echo e($post->id); ?>" action="<?php echo e(route('author.post.destroy', $post->id)); ?>" method="POST" style="display: none;">
...
<?php /* C:\xampp\htdocs\blog_sistem\resources\views/author/post/index.blade.php */ ?>