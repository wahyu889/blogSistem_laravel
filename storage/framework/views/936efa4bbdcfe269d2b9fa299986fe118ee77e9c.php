...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('author.post.update',$post->id)); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                 ...
                 <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <a class="btn btn-danger m-t-15 waves-effect" href="<?php echo e(route('author.post.index')); ?>">back</a>
...
<?php /* C:\xampp\htdocs\blog_sistem\resources\views/author/post/edit.blade.php */ ?>