                        ...
                        <div class="body">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home_with_icon_title">
                                    <form class="form-horizontal" method="POST" action="<?php echo e(route('admin.profil.update')); ?>" enctype="multipart/form-data">
                                   	<?php echo csrf_field(); ?>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="change_password_with_icon_title">
                                	...
                                	<form class="form-horizontal" method="POST" action="<?php echo e(route('admin.password.update')); ?>">
                                   	<?php echo csrf_field(); ?>
                                   	<?php echo method_field('PUT'); ?>
...
<?php /* C:\xampp\htdocs\blog_sistem\resources\views/admin/settings.blade.php */ ?>