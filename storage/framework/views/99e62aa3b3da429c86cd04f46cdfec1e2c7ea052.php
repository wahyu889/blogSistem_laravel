...
<?php $__env->startSection('content'); ?>
	 <div class="container-fluid">
         <div class="block-header">
                <h2>
                  <a href="<?php echo e(route('admin.category.create')); ?>" class="btn btn-primary wafes-efffect">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
													<a href = "<?php echo e(route('admin.category.edit', $category->id)); ?> " class="btn btn-primary wafes-effect">
														<i class="material-icons">edit</i>
													</a>
                                                    <button class="btn btn-danger wafes-effect" type="button" onclick="deleteCategory(<?php echo e($category->id); ?>)">
...
<?php /* C:\xampp\htdocs\blog_sistem\resources\views/admin/category/index.blade.php */ ?>